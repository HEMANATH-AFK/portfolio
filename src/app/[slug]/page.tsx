          ...
          <article className="flex flex-col gap-10">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
              ...
              <div className="lg:col-span-5 flex flex-col gap-4">
                ...
                <a href="https://www.linkedin.com/in/hemanath-afk" target="_blank" rel="noopener noreferrer" className="flex items-start gap-4 bg-surface/40 hover:bg-surface/75 p-4 rounded-xl border border-white/30 transition-colors">
                ...
                <a href="https://github.com/HEMANATH-AFK" target="_blank" rel="noopener noreferrer" className="flex items-start gap-4 bg-surface/40 hover:bg-surface/75 p-4 rounded-xl border border-white/30 transition-colors">
